...
import 'package:e_wallet_mobile/blocs/bloc/top_up/top_up_bloc.dart';
import 'package:e_wallet_mobile/blocs/bloc/transfer/transfer_bloc.dart';
...
class _TransferAmountScreenState extends State<TransferAmountScreen> {
  ...
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments as TransferFormModel;
                        ...
                        CustomFilledButton(
                          ...
                          onPress: () async {
                            if (await Navigator.pushNamed(context, "/pin") == true) {
                              ...
                              context.read<TransferBloc>().add(TransferPost(args.copyWith(
                                  pin: pin,
                                  amount: _controller.text.replaceAll(".", "")
                              )));
                            }
                          },
                        ),
