...
import 'package:e_wallet_mobile/blocs/bloc/payment_method/payment_method_bloc.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: (selectedPaymentMethod != null) ? Padding(
        ...
        child: CustomFilledButton(
          title: "Continue",
            onPress: () => Navigator.pushNamed(context, "/top-up-amount", arguments: TopUpFormModel(
