...
/// {@template package:e_wallet_mobile/data/mappers/user_mapper.dart}
/// Available mappings:
/// - `UserDTO` → `UserEntity`.
/// - `UserEntity` → `UserDTO`.
/// {@endtemplate}
class $UserMapper implements AutoMapprInterface {
  ...
  /// {@macro package:e_wallet_mobile/data/mappers/user_mapper.dart}
  @override
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<UserDTO>() ||
      ...
      return (_map_UserDTO_To_UserEntity((model as UserDTO?)) as TARGET);
    }
    if ((sourceTypeOf == _typeOf<UserEntity>() ||
            sourceTypeOf == _typeOf<UserEntity?>()) &&
        (targetTypeOf == _typeOf<UserDTO>() ||
      ...
      return (_map_UserEntity_To_UserDTO((model as UserEntity?)) as TARGET);
    }
    throw Exception('No ${model.runtimeType} -> $targetTypeOf mapping.');
  }

  UserEntity _map_UserDTO_To_UserEntity(UserDTO? input) {
    final model = input;
    if (model == null) {
      throw Exception(
  ...
  UserDTO _map_UserEntity_To_UserDTO(UserEntity? input) {
    final model = input;
    if (model == null) {
      throw Exception(
